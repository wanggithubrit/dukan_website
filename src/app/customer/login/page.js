        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 mb-3">
              ...
              <h1 className="text-3xl font-black text-slate-900 dark:text-white mb-1">Customer Login</h1>
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-400">Sign in to browse local shops</p>
          </div>
