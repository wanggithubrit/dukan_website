...
import { Lock, User, ArrowRight, Store, Loader } from 'lucide-react';
  ...
  useEffect(() => {
    if (user) {
      if (user.role === 'merchant') {
        ...
        showToast('Already logged in as customer. Please logout first.', 'info');
      }
    }
  }, [user]);
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (data.role === 'merchant') {
        ...
        showToast('This account is registered as customer. Please use customer login.', 'error');
      }
    } catch (err) {
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 mb-3">
              ...
              <h1 className="text-3xl font-black text-slate-900 dark:text-white">Merchant Login</h1>
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-400">Sign in to manage your shop</p>
          </div>
          ...
          <div className="text-center pt-6 border-t border-slate-200 dark:border-slate-800 mt-6">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-brand-green-100 dark:bg-brand-green-950/40 text-brand-green-700 dark:text-brand-green-400 font-bold rounded-lg hover:bg-brand-green-200 dark:hover:bg-brand-green-900/40 transition"
            >
